		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Üretimden Toplu Transfer",
									"targetURL": "#comkormasuretimdentoplutransfer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkormasuretimdentoplutransfer-display": {
								"semanticObject": "comkormasuretimdentoplutransfer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kormas.uretimdentoplutransfer",
									"url": sap.ui.require.toUrl("com/kormas/uretimdentoplutransfer")
								}
							}
						}
					}
